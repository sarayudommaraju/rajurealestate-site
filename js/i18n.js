...
(function () {
  var DICT = {
    en: {
      ...
      "hero.eyebrow": "For dreamers, families, NRIs & investors",
      "hero.title": "The home you dream of. The land you invest in. <span class=\"hl\">One name you trust.</span>",
      "hero.lead": "Your first home, the right apartment or rental, a plot to call your own, or a smart investment from abroad, we make it simple and safe. Title-clean listings across Hyderabad, Bengaluru, Chennai and Vijayawada, honest advice, and one advisor who handles it all, from the first site visit to registration.",
      ...
      "strip.title": "Ready to find a place that's truly yours?",
      "strip.body": "Tell us your city and budget. We'll send a shortlist of title-clean options within days, and walk every one for you.",
      "proc.eyebrow": "Simple & safe", "proc.title": "How buying works with us",
      "proc.sub": "Four clear steps from your first message to the keys in your hand. No jargon, no surprises.",
      "proc.s1t": "Tell us what you want", "proc.s1b": "Share your city, budget and plans over a call or WhatsApp. We listen first, then shortlist.",
      "proc.s2t": "See title-clean options", "proc.s2b": "Every property we send is pre-vetted. Visit in person or on a live video walkthrough.",
      "proc.s3t": "We handle the paperwork", "proc.s3b": "Approvals, EC, legal opinion, home loan and power of attorney, all coordinated for you.",
      "proc.s4t": "Registration & keys", "proc.s4b": "We see the deal through registration and handover, and stay on for anything after.",
      "faq.eyebrow": "Good to know", "faq.title": "Questions buyers ask us",
      "faq.q1": "Can I buy from abroad without visiting?", "faq.a1": "Yes. We run live video site visits, handle the paperwork, and arrange power of attorney so you can complete the purchase and registration without flying down.",
      "faq.q2": "How do you make sure a property has a clean title?", "faq.a2": "Every listing clears a documented check: layout and RERA/HMDA/DTCP approvals, the title chain, a 13 to 15 year encumbrance certificate, and a lawyer's opinion. You get the paperwork, not just our word.",
      "faq.q3": "Do you help first-time and local buyers too?", "faq.a3": "Absolutely. We work with families buying their first home, people looking for apartments or rentals, plot buyers and investors alike, across all four cities.",
      "faq.q4": "Do you help with home loans and registration?", "faq.a4": "Yes. We coordinate home-loan options with lenders and manage registration and handover end to end, so it's one point of contact for the whole deal.",
    ...
    te: {
      ...
      "hero.eyebrow": "కలలు కనేవారు, కుటుంబాలు, NRIలు & పెట్టుబడిదారుల కోసం",
      "hero.title": "మీరు కలగనే ఇల్లు. మీరు పెట్టుబడి పెట్టే భూమి. <span class=\"hl\">మీరు నమ్మే ఒకే పేరు.</span>",
      "hero.lead": "మీ మొదటి ఇల్లు, సరైన అపార్ట్‌మెంట్ లేదా అద్దె, మీ సొంత ప్లాట్, లేదా విదేశాల నుండి తెలివైన పెట్టుబడి, మేము దానిని సులభంగా, సురక్షితంగా చేస్తాం. హైదరాబాద్, బెంగళూరు, చెన్నై మరియు విజయవాడలో టైటిల్ స్పష్టమైన లిస్టింగ్‌లు, నిజాయితీ సలహా, మరియు మొదటి సైట్ సందర్శన నుండి రిజిస్ట్రేషన్ వరకు అంతా చూసుకునే ఒకే సలహాదారు.",
      ...
      "strip.title": "నిజంగా మీదైన ఇంటిని కనుగొనడానికి సిద్ధమా?",
      "strip.body": "మీ నగరం, బడ్జెట్ చెప్పండి. కొద్ది రోజుల్లో టైటిల్ స్పష్టమైన ఎంపికల షార్ట్‌లిస్ట్ పంపి, ప్రతిదాన్ని మీ కోసం పరిశీలిస్తాం.",
      "proc.eyebrow": "సులభం & సురక్షితం", "proc.title": "మాతో కొనుగోలు ఇలా జరుగుతుంది",
      "proc.sub": "మీ మొదటి సందేశం నుండి మీ చేతిలో తాళాల వరకు నాలుగు స్పష్టమైన దశలు. జార్గన్ లేదు, ఆశ్చర్యాలు లేవు.",
      "proc.s1t": "మీకు ఏం కావాలో చెప్పండి", "proc.s1b": "మీ నగరం, బడ్జెట్, ప్రణాళికలు కాల్ లేదా వాట్సాప్‌లో పంచుకోండి. ముందు వింటాం, తర్వాత షార్ట్‌లిస్ట్ చేస్తాం.",
      "proc.s2t": "టైటిల్ స్పష్టమైన ఎంపికలు చూడండి", "proc.s2b": "మేము పంపే ప్రతి ప్రాపర్టీ ముందే పరిశీలించబడుతుంది. స్వయంగా లేదా లైవ్ వీడియో వాక్‌త్రూలో చూడండి.",
      "proc.s3t": "పత్రాలు మేము చూసుకుంటాం", "proc.s3b": "ఆమోదాలు, EC, న్యాయ అభిప్రాయం, హోమ్ లోన్, పవర్ ఆఫ్ అటార్నీ, అన్నీ మీ కోసం సమన్వయం.",
      "proc.s4t": "రిజిస్ట్రేషన్ & తాళాలు", "proc.s4b": "రిజిస్ట్రేషన్, హ్యాండోవర్ వరకు డీల్‌ను చూసుకుంటాం, ఆ తర్వాత కూడా అండగా ఉంటాం.",
      "faq.eyebrow": "తెలుసుకోవడం మంచిది", "faq.title": "కొనుగోలుదారులు అడిగే ప్రశ్నలు",
      "faq.q1": "సందర్శించకుండా విదేశాల నుండి కొనవచ్చా?", "faq.a1": "అవును. లైవ్ వీడియో సైట్ సందర్శనలు నడుపుతాం, పత్రాలు చూసుకుంటాం, పవర్ ఆఫ్ అటార్నీ ఏర్పాటు చేస్తాం, తద్వారా మీరు రాకుండానే కొనుగోలు, రిజిస్ట్రేషన్ పూర్తి చేయవచ్చు.",
      "faq.q2": "ప్రాపర్టీకి స్పష్టమైన టైటిల్ ఉందని ఎలా నిర్ధారిస్తారు?", "faq.a2": "ప్రతి లిస్టింగ్ డాక్యుమెంటెడ్ తనిఖీ దాటుతుంది: లేఅవుట్, RERA/HMDA/DTCP ఆమోదాలు, టైటిల్ చైన్, 13 నుండి 15 సంవత్సరాల EC, న్యాయవాది అభిప్రాయం. మా మాట మాత్రమే కాదు, పత్రాలు మీకు ఇస్తాం.",
      "faq.q3": "మొదటిసారి, స్థానిక కొనుగోలుదారులకూ సహాయం చేస్తారా?", "faq.a3": "తప్పకుండా. మొదటి ఇల్లు కొనే కుటుంబాలు, అపార్ట్‌మెంట్లు లేదా అద్దె కోసం చూసేవారు, ప్లాట్ కొనేవారు, పెట్టుబడిదారులు, అందరితో నాలుగు నగరాల్లో పనిచేస్తాం.",
      "faq.q4": "హోమ్ లోన్లు, రిజిస్ట్రేషన్‌లో సహాయం చేస్తారా?", "faq.a4": "అవును. రుణదాతలతో హోమ్ లోన్ ఎంపికలను సమన్వయం చేసి, రిజిస్ట్రేషన్, హ్యాండోవర్ మొదటి నుండి చివరి వరకు నిర్వహిస్తాం, మొత్తం డీల్‌కు ఒకే సంప్రదింపు.",
    ...
    hi: {
      ...
      "hero.eyebrow": "सपने देखने वालों, परिवारों, NRI और निवेशकों के लिए",
      "hero.title": "जिस घर का आप सपना देखते हैं। जिस ज़मीन में आप निवेश करते हैं। <span class=\"hl\">एक नाम जिस पर आप भरोसा करें।</span>",
      "hero.lead": "आपका पहला घर, सही अपार्टमेंट या किराया, अपनी खुद की ज़मीन, या विदेश से एक समझदार निवेश, हम इसे आसान और सुरक्षित बनाते हैं। हैदराबाद, बेंगलुरु, चेन्नई और विजयवाड़ा में साफ़-टाइटल लिस्टिंग, ईमानदार सलाह, और एक सलाहकार जो पहली साइट विज़िट से रजिस्ट्रेशन तक सब संभालता है।",
      ...
      "strip.title": "एक ऐसी जगह ढूँढने को तैयार जो सचमुच आपकी हो?",
      "strip.body": "हमें अपना शहर और बजट बताएं। हम कुछ दिनों में साफ़-टाइटल विकल्पों की शॉर्टलिस्ट भेजेंगे और हर एक को आपके लिए देखेंगे।",
      "proc.eyebrow": "आसान और सुरक्षित", "proc.title": "हमारे साथ खरीदना कैसे होता है",
      "proc.sub": "आपके पहले संदेश से लेकर आपके हाथ में चाबी तक चार साफ़ कदम। न कोई जार्गन, न कोई आश्चर्य।",
      "proc.s1t": "बताएं आपको क्या चाहिए", "proc.s1b": "अपना शहर, बजट और योजनाएं कॉल या व्हाट्सएप पर साझा करें। हम पहले सुनते हैं, फिर शॉर्टलिस्ट करते हैं।",
      "proc.s2t": "साफ़-टाइटल विकल्प देखें", "proc.s2b": "हम जो भी प्रॉपर्टी भेजते हैं वह पहले से जाँची होती है। खुद जाकर या लाइव वीडियो वॉकथ्रू पर देखें।",
      "proc.s3t": "कागज़ात हम संभालते हैं", "proc.s3b": "स्वीकृतियाँ, EC, कानूनी राय, होम लोन और पावर ऑफ़ अटॉर्नी, सब आपके लिए समन्वित।",
      "proc.s4t": "रजिस्ट्रेशन और चाबी", "proc.s4b": "हम रजिस्ट्रेशन और हैंडओवर तक सौदा पूरा करते हैं, और उसके बाद भी साथ रहते हैं।",
      "faq.eyebrow": "जानना अच्छा है", "faq.title": "खरीदार हमसे जो पूछते हैं",
      "faq.q1": "क्या मैं बिना आए विदेश से खरीद सकता हूँ?", "faq.a1": "हाँ। हम लाइव वीडियो साइट विज़िट करते हैं, कागज़ात संभालते हैं, और पावर ऑफ़ अटॉर्नी की व्यवस्था करते हैं ताकि आप बिना आए खरीद और रजिस्ट्रेशन पूरा कर सकें।",
      "faq.q2": "आप कैसे पक्का करते हैं कि प्रॉपर्टी का टाइटल साफ़ है?", "faq.a2": "हर लिस्टिंग एक दस्तावेज़ी जाँच पास करती है: लेआउट और RERA/HMDA/DTCP स्वीकृतियाँ, टाइटल चेन, 13 से 15 साल का एनकम्ब्रेंस सर्टिफिकेट, और वकील की राय। सिर्फ़ हमारी बात नहीं, कागज़ात भी आपको मिलते हैं।",
      "faq.q3": "क्या आप पहली बार और स्थानीय खरीदारों की भी मदद करते हैं?", "faq.a3": "बिल्कुल। हम पहला घर खरीदने वाले परिवारों, अपार्टमेंट या किराया ढूँढने वालों, प्लॉट खरीदारों और निवेशकों, सभी के साथ चारों शहरों में काम करते हैं।",
      "faq.q4": "क्या आप होम लोन और रजिस्ट्रेशन में मदद करते हैं?", "faq.a4": "हाँ। हम ऋणदाताओं के साथ होम लोन विकल्पों का समन्वय करते हैं और रजिस्ट्रेशन व हैंडओवर शुरू से अंत तक संभालते हैं, ताकि पूरे सौदे के लिए एक ही संपर्क हो।",
